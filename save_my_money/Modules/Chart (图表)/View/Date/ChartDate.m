...
#pragma mark - set
- (void)setMinModel:(RecordModel *)minModel {
    _minModel = minModel;
    [self updateDateRange];
}
- (void)setMaxModel:(RecordModel *)maxModel {
    _maxModel = maxModel;
    [self updateDateRange];
}
...
//    ChartDateCell *cell = [ChartDateCell loadItem:collectionView index:indexPath];
    static NSString *name = @"ChartDateCell";
    ChartDateCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:name forIndexPath:indexPath];
