//
//  RecordCategoryCollectionView.m
//  save_my_money
//
...
@interface RecordCategoryCollectionView()<UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>

//@property (nonatomic, strong) BKCRefreshHeader *mHeader;

@end

@implementation RecordCategoryCollectionView

#pragma mark - 初始化
+ (instancetype)initWithFrame:(CGRect)frame {
    RecordCategoryCollectionView *collection = [[RecordCategoryCollectionView alloc] initWithFrame:frame collectionViewLayout:({
